...
<body>
    ...
    <div class="main-container">
        ...
        <div class="modules-section">
            ...
            <div class="modules-container">
                ...
                <a href="usuarios.php" class="module-card usuarios">
                    <div class="module-icon">
                        <i class="material-icons">people</i>
                    </div>
                    <h6>Usuarios</h6>
                ...
                <a href="elementos.php" class="module-card elementos">
                    <div class="module-icon">
                        <i class="material-icons">inventory_2</i>
                    </div>
                    <h6>Elementos</h6>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            fetch("/SII-IETSN/api/dashboard/resumen.php", {
                credentials: "same-origin"
            })
                .then(res => res.json())
                .then(res => {
                    ...
                    document.querySelector(".stat-card.loans h3").textContent =
                        res.data.prestamos_activos;

                    document.querySelector(".stat-card.available h3").textContent =
                        res.data.elementos_disponibles;

                    document.querySelector(".stat-card.users h3").textContent =
                        res.data.usuarios_activos;
                })
                .catch(err => {
